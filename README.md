# Du
### Open source Armored Core clone made in Godot 4.3
...
It currently has shaders for visual style (which I plan to refine). There's no current visual style already defined, but the 3D models I'm working on have a style more alike Armored Core 4th gen Nexts.
